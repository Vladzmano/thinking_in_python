...
class Person:
    def __init__(self, name, surname, alias = "Sin alias"): # constructor de clase, donde se establecen valores de una veriable/clase 'self se refiere a la instancia en si misma'
        self.   full_name =   f"{name} {surname} ({alias})" # El self es obligatorio pra crear esta regla o limitacion
                                                            #  Podemos crear propiedades definidad dentro o fuera de la clase
